...
/*
    This is the fragment to show the Up Coming movies.
 */
public class UpcomingMovies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view =  inflater.inflate(R.layout.upcoming_movie_layout, container, false);
    ...
    class Upcoming extends AsyncTask<Void, Void, Void> {
        @Override
        ...
        protected Void doInBackground(Void... params) {
            ...
            final String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=469afd1ae8f8cbb2f1181ac28519d9a0&language=en-US&page=1";
            final String json = httpHandler.makeServiceCall(url);
            Log.i("Up Coming Movies", json);
            if(json != null) {
                try {
                    ...
                    mActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAdapter = new MyAdapter(title, overview, releaseDate, img, mActivity, resultsArray.length(), voteAverage, popularity, isAdultMovie, R.layout.upcoming_movie_layout);
